...
epicsShareFuncSDDS extern int32_t SDDS_SprintTypedValue(void *data, int32_t index, int32_t type, const char *format, char *buffer, uint32_t mode);
epicsShareFuncSDDS extern int32_t SDDS_SprintTypedValueFactor(void *data, int32_t index, int32_t type, const char *format, char *buffer, uint32_t mode, double factor);
...
epicsShareFuncSDDS extern int32_t SDDS_CreateRpnMemory(const char *name, short is_string);
...
epicsShareFuncSDDS extern char **getMatchingSDDSNames(SDDS_DATASET *dataset, char **matchName, long matches, int32_t *names,  short match_type);
