...
#define SDDS_INTEGER_TYPE(type) ((type)==SDDS_LONG64 || (type)==SDDS_ULONG64 || (type)==SDDS_LONG || (type)==SDDS_ULONG || (type)==SDDS_SHORT || (type)==SDDS_USHORT)
#define SDDS_FLOATING_TYPE(type) ((type)==SDDS_LONGDOUBLE || (type)==SDDS_DOUBLE || (type)==SDDS_FLOAT)
