...
#define SDDS_ReadTable(a) SDDS_ReadPage(a)
  ...
  epicsShareFuncSDDS extern int32_t SDDS_BufferedRead(void *target, int64_t targetSize, FILE *fp, SDDS_FILEBUFFER *fBuffer);
#if defined(zLib)
  epicsShareFuncSDDS extern int32_t SDDS_GZipBufferedRead(void *target, int64_t targetSize, gzFile gzfp, SDDS_FILEBUFFER *fBuffer);
#endif
