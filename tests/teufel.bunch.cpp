...
int main ()
{
    ...
    dist->generateGaussian(0, 0.0, 0.002);	// x gaussian displaced 1mm with sigma=2mm
    dist->generateGaussian(1, 0.0, 0.001);	// y gaussian with sigma=1mm
    dist->generateGaussian(2, 0.0, 0.0003);	// z gaussian with sigma=0.3mm
    dist->generateGaussian(3, 0.0, 0.001);	// px gaussian
    dist->generateGaussian(4, 0.0, 0.001);	// py gaussian
    dist->generateGaussian(5, 0.0, 0.001);	// pz gaussian
