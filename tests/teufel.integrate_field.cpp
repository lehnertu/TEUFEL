...
int main ()
{
    ...
    if (fabs(ft->get_field(0).E().x - 0.725)>1e-6) errors++;
    if (fabs(ft->get_field(1).E().x - 1.3)>1e-6) errors++;
    if (fabs(ft->get_field(2).E().x - 1.1)>1e-6) errors++;
    if (fabs(ft->get_field(3).E().x - 0.9)>1e-6) errors++;
    if (fabs(ft->get_field(4).E().x - 0.7)>1e-6) errors++;
    if (fabs(ft->get_field(5).E().x - 0.275)>1e-6) errors++;
    if (fabs(ft->get_field(6).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(7).E().x - 0.0)>1e-6) errors++;
    printf("\n");
    delete ft;
    ...
    if (fabs(ft->get_field(0).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(1).E().x - 1.4)>1e-6) errors++;
    if (fabs(ft->get_field(2).E().x - 1.2)>1e-6) errors++;
    if (fabs(ft->get_field(3).E().x - 1.0)>1e-6) errors++;
    if (fabs(ft->get_field(4).E().x - 0.8)>1e-6) errors++;
    if (fabs(ft->get_field(5).E().x - 0.6)>1e-6) errors++;
    if (fabs(ft->get_field(6).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(7).E().x - 0.0)>1e-6) errors++;
    printf("\n");
    delete ft;
    ...
    if (fabs(ft->get_field(0).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(1).E().x - 0.3125)>1e-6) errors++;
    if (fabs(ft->get_field(2).E().x - 0.1875)>1e-6) errors++;
    if (fabs(ft->get_field(3).E().x - 0.0)>1e-6) errors++;
    printf("\n");
    delete ft;
    ...
    if (fabs(ft->get_field(0).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(1).E().x - 0.5)>1e-6) errors++;
    if (fabs(ft->get_field(2).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(3).E().x - 0.0)>1e-6) errors++;
    printf("\n");
    delete ft;
    delete B;
    ...
    if (fabs(ft->get_field(0).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(1).E().x - 0.0)>1e-6) errors++;
    if (fabs(ft->get_field(2).E().x - 0.5)>1e-6) errors++;
    if (fabs(ft->get_field(3).E().x - 1.0)>1e-6) errors++;
    if (fabs(ft->get_field(4).E().x - 0.9875)>1e-6) errors++;
    if (fabs(ft->get_field(5).E().x - 0.316667)>1e-6) errors++;
    if (fabs(ft->get_field(6).E().x - 0.395833)>1e-6) errors++;
    if (fabs(ft->get_field(7).E().x - 0.0)>1e-6) errors++;
    delete ft;
    delete B;
