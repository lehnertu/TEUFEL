...
sddsplot -columnNames=z,'(xMean,yMean,zMean,pxMean,pyMean,pzMean,AxMean,AyMean,AzMean,xStDev,yStDev,zStDev,pxStDev,pyStDev,pzStDev)' -separate -graphic=line,vary -legend traj.env
